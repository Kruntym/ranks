...
FACTION.name = "Ember Platoon - Command"
FACTION.color = Color(235, 161, 52)
FACTION.description = ""
FACTION.selectModelText = "Select a model"
FACTION.image = ix.util.GetMaterial("trex/command.png")
...
function FACTION:OnSpawn(client)
   client:SetPlayerColor(Vector(151 / 255, 54 / 255, 179 / 255))
end
